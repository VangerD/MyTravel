    ...
    <section class="ftco-section bg-primary">
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                <div class="form-login p-4 p-md-5 ">
                    <img src="image/logo.jpeg" class="logo mx-auto d-block mb-3" style="width:20" alt="logo">
                    ...
                    <form action="/register" method="post">@csrf
                        ...
                        <div class="form-group d-flex">
                            <input type="text" class="form-control rounded-left" placeholder="Nama Pengguna" required>
                        </div>
                        <div class="form-group d-flex">
                        ...
                        <small class="d-block text-center mt-3">
                            <a href="/login">Sudah Punya Akun?</a></small>
                </div>
                </form>
            </div>
        </div>
